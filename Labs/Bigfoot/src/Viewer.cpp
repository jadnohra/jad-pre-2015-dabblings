...
class BigfootViewerScene : public BE::SimpleRenderToTextureWidget::Scene, public BE::MainWindowClient
{
public:
	...
	BigfootViewerScene::BigfootViewerScene() 
...
void CreateWidgets(BE::MainWindow& inWindow, BigfootViewerScene& inScene);


int ViewerMain()
{
	BigfootViewerScene scene;
...
void BigfootViewerScene::RenderTestBasicScene(BE::Renderer& inRenderer)
{
...
int BigfootViewerScene::SliderToFrameIndex(float inSliderPos) const
{
	int frame_index = -1;
...
float BigfootViewerScene::FrameIndexToSlider(int inFrameIndex) const
{
...
void BigfootViewerScene::RenderTestSkeletonScene(BE::Renderer& inRenderer)
{
	...
	render_settings.pTreeInfo = NULL;
	render_settings.showSemantics = false;
...
bool BigfootViewerScene::Create()
{
...
void BigfootViewerScene::OnFileDropped(BE::MainWindow* inWindow, const char* inFilePath)
{
...
float BigfootViewerScene::GetPlaySpeed() 
{
...
void BigfootViewerScene::ProcessWidgetEvents(BE::MainWindow* inWindow, BE::WidgetEventManager& inManager)
{
...
void BigfootViewerScene::Update(const BE::WidgetContext& context, BE::SimpleRenderToTextureWidget& inParent, BE::OGLRenderToTexture& inTexture)	
{
	mTexture = &inTexture;
...
void BigfootViewerScene::Unproject(const glm::vec2& inViewportPoint, glm::vec3& outSceneWorldPoint, glm::vec3* outSceneWorldRayDir)
{
...
void BigfootViewerScene::OnFirstUpdate()
{
	//OnFileDropped(NULL, "../media/test.bvh");
}


void BigfootViewerScene::Render(BE::Renderer& inRenderer)	
{
